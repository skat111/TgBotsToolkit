...
Source: https://core.telegram.org/api/bots%2Fgames
...
Games are started by clicking on a [keyboardButtonGame](https://core.telegram.org/constructor/keyboardButtonGame), which triggers a callback query that returns the game URL.
