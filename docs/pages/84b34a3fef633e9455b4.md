...
Source: https://core.telegram.org/api/subscriptions
...
See [here »](https://core.telegram.org/api/subscriptions#managing-subscriptions) for more info on how to handle active subscriptions as a subscriber.
...
* `restore`: If **not** set, disables auto-renewal of the subscriptions, and prevents the user from reactivating the subscription once the current period expires: a subscription cancelled by the bot will have the [starsSubscription](https://core.telegram.org/constructor/starsSubscription).`bot_canceled` flag set.  
...
See [here »](https://core.telegram.org/api/subscriptions#managing-subscriptions) for more info on how to handle active subscriptions as a subscriber: the [starsSubscription](https://core.telegram.org/constructor/starsSubscription) constructor associated with bot subscriptions will have the `invoice_slug` flag set.
