...
Source: https://core.telegram.org/bug-bounty
...
Security researchers can [submit](https://core.telegram.org/bug-bounty#submission) any relevant issues they find at [security@telegram.org](mailto:security@telegram.org). All reports submitted in accordance with the [rules](https://core.telegram.org/bug-bounty#rules-and-principles) and [scope](https://core.telegram.org/bug-bounty#program-scope) outlined below which result in a change of code or configuration are eligible for bounties, ranging from **$100** to **$100,000** or more, depending on the severity of the issue.
...
Researchers are welcome to use our dedicated **test environment** if they require it – instructions on how to access it can be found [here](https://core.telegram.org/bug-bounty#test-environment).
...
If you found an issue which is [in scope](https://core.telegram.org/bug-bounty#program-scope), is [eligible](https://core.telegram.org/bug-bounty#non-qualifying-issues) and was found in accordance to our [rules](https://core.telegram.org/bug-bounty#rules-and-principles), you are welcome to submit it to [security@telegram.org](mailto:security@telegram.org).
