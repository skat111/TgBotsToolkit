...
Until [web\_app\_stop\_gyroscope](https://core.telegram.org/api/web-events#web-app-stop-gyroscope) is emitted by the mini app, the client will also emit [gyroscope\_changed events](https://core.telegram.org/api/bots/webapps#gyroscope-changed) at most every `refresh_rate` milliseconds with gyroscope readings.
