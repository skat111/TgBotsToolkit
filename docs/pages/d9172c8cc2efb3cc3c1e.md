...
Similar to [400 BAD\_REQUEST](https://core.telegram.org/api/errors#400-bad-request), but the app must display the error to the user a bit differently.  
