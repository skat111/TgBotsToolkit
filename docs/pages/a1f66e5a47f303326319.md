...
Source: https://core.telegram.org/api/block
...
Peers in the story blocklist won't be able to view your [stories](https://core.telegram.org/api/stories).  
Peers in the main blocklist won't be able to write messages to you, view your status, photo, and stories.

Adding or removing a peer from a blocklist will emit an [updatePeerBlocked](https://core.telegram.org/constructor/updatePeerBlocked) to all currently logged-in sessions (the peer we blocked/unblocked *won't* receive any update).
