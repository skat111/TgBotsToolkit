...
Source: https://core.telegram.org/api/custom-emoji
...
Additionally, custom emojis and non-mask stickers may also have a set of *custom* keywords, returned in the [custom emoji stickerset information](https://core.telegram.org/api/stickers#stickersets):
