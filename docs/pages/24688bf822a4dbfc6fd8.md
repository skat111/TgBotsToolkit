...
* Added **bots\_guestchat** parameter in [contacts.getTopPeers](https://core.telegram.org/method/contacts.getTopPeers)
* Added **tone** parameter, removed **change\_tone** parameter in [messages.composeMessageWithAI](https://core.telegram.org/method/messages.composeMessageWithAI)
...
* Added **bot\_guestchat** parameter in [user](https://core.telegram.org/constructor/user)
* Added **guestchat\_via\_from** parameter in [message](https://core.telegram.org/constructor/message)
* Added **premium\_days** parameter in [auth.sentCodePaymentRequired](https://core.telegram.org/constructor/auth.sentCodePaymentRequired)
* Added **subscribers\_only**, **countries\_iso2** parameters in [poll](https://core.telegram.org/constructor/poll)
* Added **can\_view\_stats** parameter in [pollResults](https://core.telegram.org/constructor/pollResults)
* Added **send\_reactions** parameter in [chatBannedRights](https://core.telegram.org/constructor/chatBannedRights)
* Added **premium\_days** parameter in [inputStorePaymentAuthCode](https://core.telegram.org/constructor/inputStorePaymentAuthCode)
...
* Added **poll\_hash** parameter in [messages.getPollResults](https://core.telegram.org/method/messages.getPollResults)
* Added **tone** parameter in [messages.translateText](https://core.telegram.org/method/messages.translateText)
* Added **flags**, **webapp\_req\_id** parameters, changed type of **msg\_id** from **int** to **flags.0?int** in [messages.sendBotRequestedPeer](https://core.telegram.org/method/messages.sendBotRequestedPeer)
...
* Added **live\_photo**, **video** parameters in [inputMediaUploadedPhoto](https://core.telegram.org/constructor/inputMediaUploadedPhoto)
* Added **live\_photo**, **video** parameters in [inputMediaPhoto](https://core.telegram.org/constructor/inputMediaPhoto)
* Added **attached\_media**, **solution\_media** parameters, changed type of **correct\_answers** from **flags.0?Vector<bytes>** to **flags.0?Vector<int>** in [inputMediaPoll](https://core.telegram.org/constructor/inputMediaPoll)
* Added **bot\_can\_manage\_bots** parameter in [user](https://core.telegram.org/constructor/user)
* Added **live\_photo**, **video** parameters in [messageMediaPhoto](https://core.telegram.org/constructor/messageMediaPhoto)
* Added **flags**, **attached\_media** parameters in [messageMediaPoll](https://core.telegram.org/constructor/messageMediaPoll)
* Added **unread\_poll\_votes\_count** parameter in [dialog](https://core.telegram.org/constructor/dialog)
* Added **unofficial\_security\_risk**, **bot\_manager\_id** parameters in [userFull](https://core.telegram.org/constructor/userFull)
* Added **peer**, **msg\_id**, **top\_msg\_id** parameters in [updateMessagePoll](https://core.telegram.org/constructor/updateMessagePoll)
* Added **positions** parameter in [updateMessagePollVote](https://core.telegram.org/constructor/updateMessagePollVote)
* Added **flags**, **media**, **added\_by**, **date** parameters in [pollAnswer](https://core.telegram.org/constructor/pollAnswer)
* Added **open\_answers**, **revoting\_disabled**, **shuffle\_answers**, **hide\_results\_until\_close**, **creator**, **hash** parameters in [poll](https://core.telegram.org/constructor/poll)
* Added **recent\_voters** parameter, changed type of **voters** from **int** to **flags.2?int** in [pollAnswerVoters](https://core.telegram.org/constructor/pollAnswerVoters)
* Added **has\_unread\_votes**, **solution\_media** parameters in [pollResults](https://core.telegram.org/constructor/pollResults)
* Added **is\_app**, **verified\_app\_name** parameters in [urlAuthResultRequest](https://core.telegram.org/constructor/urlAuthResultRequest)
* Added **poll\_option** parameter in [messageReplyHeader](https://core.telegram.org/constructor/messageReplyHeader)
* Added **unread\_poll\_votes\_count** parameter in [forumTopic](https://core.telegram.org/constructor/forumTopic)
* Added **music** parameter in [storyItem](https://core.telegram.org/constructor/storyItem)
* Added **poll\_option** parameter in [inputReplyToMessage](https://core.telegram.org/constructor/inputReplyToMessage)
* Added **poll\_votes\_notify\_from** parameter in [reactionsNotifySettings](https://core.telegram.org/constructor/reactionsNotifySettings)
...
* Added **in\_app\_origin** parameter in [messages.requestUrlAuth](https://core.telegram.org/method/messages.requestUrlAuth)
* Added **share\_phone\_number**, **match\_code** parameters in [messages.acceptUrlAuth](https://core.telegram.org/method/messages.acceptUrlAuth)
* Added **flags**, **request\_msg\_id** parameters in [messages.toggleNoForwards](https://core.telegram.org/method/messages.toggleNoForwards)
* Added **stars\_only** parameter in [payments.getResaleStarGifts](https://core.telegram.org/method/payments.getResaleStarGifts)
...
* Added **from\_rank** parameter in [message](https://core.telegram.org/constructor/message)
* Added **noforwards\_my\_enabled**, **noforwards\_peer\_enabled** parameters in [userFull](https://core.telegram.org/constructor/userFull)
...
* Added **edit\_rank** parameter in [channelAdminLogEventsFilter](https://core.telegram.org/constructor/channelAdminLogEventsFilter)
* Added **manage\_ranks** parameter in [chatAdminRights](https://core.telegram.org/constructor/chatAdminRights)
* Added **edit\_rank** parameter in [chatBannedRights](https://core.telegram.org/constructor/chatBannedRights)
* Added **match\_codes\_first**, **match\_codes**, **user\_id\_hint** parameters in [urlAuthResultRequest](https://core.telegram.org/constructor/urlAuthResultRequest)

#### PUSH notification changes

##### New PUSH notifications

* Added [OAUTH\_REQUEST](https://core.telegram.org/api/push-updates#oauth-request) - `Login request for {1} from {2}`
...
* Added **for\_craft** parameter in [payments.getResaleStarGifts](https://core.telegram.org/method/payments.getResaleStarGifts)
...
* Added **summary\_from\_language** parameter in [message](https://core.telegram.org/constructor/message)
* Removed **legacy\_ios** parameter in [messageService](https://core.telegram.org/constructor/messageService)
* Added **bot\_forum\_can\_manage\_topics** parameter in [user](https://core.telegram.org/constructor/user)
...
* Added **request\_phone\_number**, **browser**, **platform**, **ip**, **region** parameters in [urlAuthResultRequest](https://core.telegram.org/constructor/urlAuthResultRequest)
...
* Added **flags**, **game\_outcome** parameters in [messageMediaDice](https://core.telegram.org/constructor/messageMediaDice)
...
* Added **flags**, **crafted**, **rarity** parameters, removed **rarity\_permille** parameter in [starGiftAttributeModel](https://core.telegram.org/constructor/starGiftAttributeModel)
* Added **rarity** parameter, removed **rarity\_permille** parameter in [starGiftAttributePattern](https://core.telegram.org/constructor/starGiftAttributePattern)
* Added **rarity** parameter, removed **rarity\_permille** parameter in [starGiftAttributeBackdrop](https://core.telegram.org/constructor/starGiftAttributeBackdrop)
* Added **burned**, **crafted**, **craft\_chance\_permille** parameters in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
* Added **craft**, **can\_craft\_at** parameters in [messageActionStarGiftUnique](https://core.telegram.org/constructor/messageActionStarGiftUnique)
* Added **can\_craft\_at** parameter in [savedStarGift](https://core.telegram.org/constructor/savedStarGift)

#### PUSH notification changes

##### New PUSH notifications

* Added [STORY\_LIVE](https://core.telegram.org/api/push-updates#story-live) - `started a live stream!`
...
* Added **legacy\_ios** parameter in [messageService](https://core.telegram.org/constructor/messageService)
* Added **auction\_start\_date**, **upgrade\_variants**, **background** parameters in [starGift](https://core.telegram.org/constructor/starGift)
* Added **gift\_num** parameter in [messageActionStarGift](https://core.telegram.org/constructor/messageActionStarGift)
* Added **value\_usd\_amount**, **offer\_min\_stars** parameters in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
* Added **from\_offer** parameter in [messageActionStarGiftUnique](https://core.telegram.org/constructor/messageActionStarGiftUnique)
* Added **gift\_num** parameter in [savedStarGift](https://core.telegram.org/constructor/savedStarGift)
* Added **last\_gift\_num**, **rounds** parameters in [starGiftAuctionState](https://core.telegram.org/constructor/starGiftAuctionState)
* Added **flags**, **listed\_count**, **fragment\_listed\_count**, **fragment\_listed\_url** parameters in [starGiftAuctionStateFinished](https://core.telegram.org/constructor/starGiftAuctionStateFinished)
* Added **chats** parameter in [payments.starGiftAuctionState](https://core.telegram.org/constructor/payments.starGiftAuctionState)
* Added **gift\_num** parameter in [starGiftAuctionAcquiredGift](https://core.telegram.org/constructor/starGiftAuctionAcquiredGift)
...
* Removed **center\_color**, **edge\_color**, **text\_color** parameters in [webPageAttributeStarGiftAuction](https://core.telegram.org/constructor/webPageAttributeStarGiftAuction)
...
* Added **stargift\_auction\_bid** parameter in [starsTransaction](https://core.telegram.org/constructor/starsTransaction)
* Added **auction**, **auction\_slug**, **gifts\_per\_round** parameters in [starGift](https://core.telegram.org/constructor/starGift)
* Added **auction\_acquired**, **to\_id** parameters in [messageActionStarGift](https://core.telegram.org/constructor/messageActionStarGift)
...
* Added **schedule\_repeat\_period** parameter in [messages.sendMessage](https://core.telegram.org/method/messages.sendMessage)
* Added **schedule\_repeat\_period** parameter in [messages.sendMedia](https://core.telegram.org/method/messages.sendMedia)
* Added **schedule\_repeat\_period** parameter in [messages.forwardMessages](https://core.telegram.org/method/messages.forwardMessages)
* Added **schedule\_repeat\_period** parameter in [messages.editMessage](https://core.telegram.org/method/messages.editMessage)
* Added **send\_paid\_messages\_stars** parameter in [phone.toggleGroupCallSettings](https://core.telegram.org/method/phone.toggleGroupCallSettings)
* Added **for\_live\_stories** parameter in [channels.getSendAs](https://core.telegram.org/method/channels.getSendAs)
* Added **flags**, **live\_story** parameters in [phone.getGroupCallStreamRtmpUrl](https://core.telegram.org/method/phone.getGroupCallStreamRtmpUrl)
...
* Added **flags**, **allow\_paid\_stars**, **send\_as** parameters in [phone.sendGroupCallMessage](https://core.telegram.org/method/phone.sendGroupCallMessage)
...
* Added **schedule\_repeat\_period** parameter in [message](https://core.telegram.org/constructor/message)
* Changed type of **stories\_max\_id** from **flags2.5?int** to **flags2.5?RecentStory** in [user](https://core.telegram.org/constructor/user)
* Changed type of **stories\_max\_id** from **flags2.4?int** to **flags2.4?RecentStory** in [channel](https://core.telegram.org/constructor/channel)
* Added **send\_paid\_messages\_stars**, **default\_send\_as** parameters in [groupCall](https://core.telegram.org/constructor/groupCall)
* Added **paid\_stars\_total** parameter in [groupCallParticipant](https://core.telegram.org/constructor/groupCallParticipant)
* Added **live\_story**, **peer** parameters, removed **chat\_id** parameter in [updateGroupCall](https://core.telegram.org/constructor/updateGroupCall)
...
* Added **phonegroup\_message** parameter in [starsTransaction](https://core.telegram.org/constructor/starsTransaction)
* Added **disallow\_stargifts\_from\_channels** parameter in [disallowedGiftsSettings](https://core.telegram.org/constructor/disallowedGiftsSettings)
* Changed type of **completed\_by** from **long** to **Peer** in [todoCompletion](https://core.telegram.org/constructor/todoCompletion)
* Removed **from\_id**, **random\_id** parameters, changed type of **message** from **TextWithEntities** to **GroupCallMessage** in [updateGroupCallMessage](https://core.telegram.org/constructor/updateGroupCallMessage)
...
* Added **messages\_enabled** parameter in [phone.toggleGroupCallSettings](https://core.telegram.org/method/phone.toggleGroupCallSettings)
* Removed **background\_emoji\_id** parameter, changed type of **color** from **flags.2?int** to **flags.2?PeerColor** in [account.updateColor](https://core.telegram.org/method/account.updateColor)
* Added **peer\_color\_available**, **exclude\_hosted** parameters in [payments.getSavedStarGifts](https://core.telegram.org/method/payments.getSavedStarGifts)
...
* Added **flags**, **top\_msg\_id** parameters in [updateUserTyping](https://core.telegram.org/constructor/updateUserTyping)
* Added **top\_msg\_id** parameter in [updateReadHistoryInbox](https://core.telegram.org/constructor/updateReadHistoryInbox)
* Added **bot\_forum\_view** parameter in [user](https://core.telegram.org/constructor/user)
* Added **messages\_enabled**, **can\_change\_messages\_enabled**, **min** parameters in [groupCall](https://core.telegram.org/constructor/groupCall)
* Added **title\_missing**, **peer** parameters in [forumTopic](https://core.telegram.org/constructor/forumTopic)
* Added **title\_missing** parameter in [messageActionTopicCreate](https://core.telegram.org/constructor/messageActionTopicCreate)
* Added **peer\_color\_available** parameter in [starGift](https://core.telegram.org/constructor/starGift)
* Added **peer\_color**, **host\_id** parameters in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
...
* Added [MESSAGE\_SUGGEST\_BIRTHDAY](https://core.telegram.org/api/push-updates#message-suggest-birthday) - `{1} suggested you your birthday`
...
* [payments.starGiftUpgradePreview](https://core.telegram.org/constructor/payments.starGiftUpgradePreview) now returns a list of future [gift upgrade](https://core.telegram.org/api/gifts#collectible-gifts) prices in **prices** and **next\_prices**.
...
* Changed type of **next\_offset** from **flags.0?int** to **flags.0?string** in [account.chatThemes](https://core.telegram.org/constructor/account.chatThemes)
* Added **stargift\_drop\_original\_details** parameter in [starsTransaction](https://core.telegram.org/constructor/starsTransaction)
* Added **drop\_original\_details\_stars** parameter in [messageActionStarGiftUnique](https://core.telegram.org/constructor/messageActionStarGiftUnique)
* Added **prices**, **next\_prices** parameters in [payments.starGiftUpgradePreview](https://core.telegram.org/constructor/payments.starGiftUpgradePreview)
* Added **drop\_original\_details\_stars** parameter in [savedStarGift](https://core.telegram.org/constructor/savedStarGift)
...
* [Corrected hash generation instructions for messages.getScheduledHistory, the correct order is id, edit\_date, date; not id, date, edit\_date »](https://core.telegram.org/method/messages.getScheduledHistory)
...
* Added device storage and secure storage APIs for [mini apps](https://core.telegram.org/api/bots/webapps), using the following events:
  ...
  + [web\_app\_device\_storage\_save\_key](https://core.telegram.org/api/web-events#web-app-device-storage-save-key) - Save or remove a value from the device's local storage associated with this user and mini app
  + [web\_app\_device\_storage\_get\_key](https://core.telegram.org/api/web-events#web-app-device-storage-get-key) - Get a value from the device's local storage associated with this user and mini app
  + [web\_app\_device\_storage\_clear](https://core.telegram.org/api/web-events#web-app-device-storage-clear) - Clear the device's local storage associated with this user and mini app
  + [web\_app\_secure\_storage\_save\_key](https://core.telegram.org/api/web-events#web-app-secure-storage-save-key) - Save or remove a value from the device's secure storage associated with this user and mini app
  + [web\_app\_secure\_storage\_get\_key](https://core.telegram.org/api/web-events#web-app-secure-storage-get-key) - Get a value from the device's secure storage associated with this user and mini app
  + [web\_app\_secure\_storage\_restore\_key](https://core.telegram.org/api/web-events#web-app-secure-storage-restore-key) - Restore a value to the device's secure storage associated with this user and mini app
  + [web\_app\_secure\_storage\_clear](https://core.telegram.org/api/web-events#web-app-secure-storage-clear) - Clear the device's secure storage associated with this user and mini app
...
* Added **support\_email\_address**, **support\_email\_subject** parameters in [auth.sentCodePaymentRequired](https://core.telegram.org/constructor/auth.sentCodePaymentRequired)
* Added **theme** parameter, removed **theme\_emoticon** parameter in [userFull](https://core.telegram.org/constructor/userFull)
* Added **theme\_available**, **theme\_peer** parameters in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)

#### PUSH notification changes

##### New PUSH notifications

* Added [MESSAGE\_STARGIFT\_UNPACK\_UPGRADE](https://core.telegram.org/api/push-updates#message-stargift-unpack-upgrade) - `{1} unpacked the Gift that you helped upgrade`
...
* Added **main\_tab** parameter in [channelFull](https://core.telegram.org/constructor/channelFull)
* Added **upgrade\_separate** parameter in [messageActionStarGift](https://core.telegram.org/constructor/messageActionStarGift)
* Added **main\_tab**, **saved\_music** parameters in [userFull](https://core.telegram.org/constructor/userFull)
* Added **flags**, **spend\_purpose\_peer** parameters in [inputStorePaymentStarsTopup](https://core.telegram.org/constructor/inputStorePaymentStarsTopup)
* Added **locked\_until\_date** parameter in [starGift](https://core.telegram.org/constructor/starGift)
...
* Added **upgrade\_separate** parameter in [savedStarGift](https://core.telegram.org/constructor/savedStarGift)
...
* Added **exclude\_upgradable**, **exclude\_unupgradable** parameters, removed **exclude\_limited** parameter in [payments.getSavedStarGifts](https://core.telegram.org/method/payments.getSavedStarGifts)
...
* Added **prepaid\_upgrade**, **prepaid\_upgrade\_hash**, **gift\_msg\_id** parameters in [messageActionStarGift](https://core.telegram.org/constructor/messageActionStarGift)
* Added **prepaid\_upgrade** parameter in [messageActionStarGiftUnique](https://core.telegram.org/constructor/messageActionStarGiftUnique)
* Added **posts\_search**, **stargift\_prepaid\_upgrade** parameters in [starsTransaction](https://core.telegram.org/constructor/starsTransaction)
* Added **gift\_id**, **value\_amount**, **value\_currency** parameters in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
* Added **prepaid\_upgrade\_hash** parameter in [savedStarGift](https://core.telegram.org/constructor/savedStarGift)
...
* Added **flags**, **query**, **allow\_paid\_stars** parameters, changed type of **hashtag** from **string** to **flags.0?string** in [channels.searchPosts](https://core.telegram.org/method/channels.searchPosts)
* Added **resell\_amount** parameter, removed **resell\_stars** parameter in [payments.updateStarGiftPrice](https://core.telegram.org/method/payments.updateStarGiftPrice)
...
* Added **resale\_amount** parameter, removed **resale\_stars** parameter in [messageActionStarGiftUnique](https://core.telegram.org/constructor/messageActionStarGiftUnique)
* Added **stars\_my\_pending\_rating**, **stars\_my\_pending\_rating\_date** parameters in [userFull](https://core.telegram.org/constructor/userFull)
* Added **search\_flood** parameter in [messages.messagesSlice](https://core.telegram.org/constructor/messages.messagesSlice)
...
* Added **resale\_ton\_only**, **resell\_amount** parameters, removed **resell\_stars** parameter in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
...
* Added **collection\_id** parameter in [payments.getSavedStarGifts](https://core.telegram.org/method/payments.getSavedStarGifts)
...
* Added **stars\_rating** parameter in [userFull](https://core.telegram.org/constructor/userFull)
* Added **require\_premium**, **limited\_per\_user**, **per\_user\_total**, **per\_user\_remains** parameters in [starGift](https://core.telegram.org/constructor/starGift)
* Added **require\_premium** parameter in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
* Added **collection\_id** parameter in [savedStarGift](https://core.telegram.org/constructor/savedStarGift)
...
* Added **todo\_item\_id** parameter in [messageReplyHeader](https://core.telegram.org/constructor/messageReplyHeader)
* Added **todo\_item\_id** parameter in [inputReplyToMessage](https://core.telegram.org/constructor/inputReplyToMessage)
* Removed **posts\_search** parameter in [starsTransaction](https://core.telegram.org/constructor/starsTransaction)
...
* Added **suggested\_post** parameter in [messages.sendMessage](https://core.telegram.org/method/messages.sendMessage)
* Added **suggested\_post** parameter in [messages.sendMedia](https://core.telegram.org/method/messages.sendMedia)
* Added **suggested\_post** parameter in [messages.forwardMessages](https://core.telegram.org/method/messages.forwardMessages)
* Added **suggested\_post** parameter in [messages.saveDraft](https://core.telegram.org/method/messages.saveDraft)
...
* Added **paid\_suggested\_post\_stars**, **paid\_suggested\_post\_ton**, **suggested\_post** parameters in [message](https://core.telegram.org/constructor/message)
* Added **suggested\_post** parameter in [draftMessage](https://core.telegram.org/constructor/draftMessage)
* Added **manage\_direct\_messages** parameter in [chatAdminRights](https://core.telegram.org/constructor/chatAdminRights)
* Added **posts\_search**, **amount**, **ads\_proceeds\_from\_date**, **ads\_proceeds\_to\_date** parameters, removed **stars** parameter in [starsTransaction](https://core.telegram.org/constructor/starsTransaction)
* Added **flags**, **top\_hours\_graph** parameters in [payments.starsRevenueStats](https://core.telegram.org/constructor/payments.starsRevenueStats)
* Added **released\_by** parameter in [starGift](https://core.telegram.org/constructor/starGift)
* Added **chats**, **users** parameters in [payments.starGifts](https://core.telegram.org/constructor/payments.starGifts)
* Added **released\_by** parameter in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
...
* Added **flags**, **msg\_id** parameters in [messages.getSponsoredMessages](https://core.telegram.org/method/messages.getSponsoredMessages)
* Added **flags**, **parent\_peer** parameters in [account.getPaidMessagesRevenue](https://core.telegram.org/method/account.getPaidMessagesRevenue)
...
* Added **saved\_peer\_id** parameter in [messageService](https://core.telegram.org/constructor/messageService)
* Added **send\_paid\_messages\_stars** parameter in [channelFull](https://core.telegram.org/constructor/channelFull)
* Added **min\_display\_duration**, **max\_display\_duration** parameters in [sponsoredMessage](https://core.telegram.org/constructor/sponsoredMessage)
* Added **start\_delay**, **between\_delay** parameters in [messages.sponsoredMessages](https://core.telegram.org/constructor/messages.sponsoredMessages)
* Added **nopaid\_messages\_exception** parameter in [monoForumDialog](https://core.telegram.org/constructor/monoForumDialog)

#### PUSH notification changes

##### New PUSH notifications

* Added [CHANNEL\_MESSAGE\_TODO](https://core.telegram.org/api/push-updates#channel-message-todo) - `{1} posted a checklist {2}`
* Added [CHANNEL\_MESSAGE\_TODO\_APPEND](https://core.telegram.org/api/push-updates#channel-message-todo-append) - `{1} added {2} tasks`
* Added [CHANNEL\_MESSAGE\_TODO\_DONE](https://core.telegram.org/api/push-updates#channel-message-todo-done) - `{1} toggled {2} tasks`
* Added [CHAT\_MESSAGE\_TODO](https://core.telegram.org/api/push-updates#chat-message-todo) - `{1} sent a checklist {3} to the group {2}`
* Added [CHAT\_MESSAGE\_TODO\_APPEND](https://core.telegram.org/api/push-updates#chat-message-todo-append) - `{1} added {3} tasks in the group {2}`
* Added [CHAT\_MESSAGE\_TODO\_DONE](https://core.telegram.org/api/push-updates#chat-message-todo-done) - `{1} toggled {3} tasks in the group {2}`
* Added [CHAT\_REACT\_TODO](https://core.telegram.org/api/push-updates#chat-react-todo) - `{1}: {3} to your checklist {4} in {2}`
* Added [MESSAGE\_TODO](https://core.telegram.org/api/push-updates#message-todo) - `{1} sent you a checklist {2}`
* Added [PINNED\_TODO](https://core.telegram.org/api/push-updates#pinned-todo) - `{1} pinned a checklist {2}`
* Added [REACT\_TODO](https://core.telegram.org/api/push-updates#react-todo) - `{1}: {2} to your checklist {3}`
...
* Added **reply\_to** parameter in [messages.forwardMessages](https://core.telegram.org/method/messages.forwardMessages)
* Added **parent\_peer** parameter in [messages.markDialogUnread](https://core.telegram.org/method/messages.markDialogUnread)
* Added **flags**, **parent\_peer** parameters in [messages.getDialogUnreadMarks](https://core.telegram.org/method/messages.getDialogUnreadMarks)
* Added **saved\_peer\_id** parameter in [messages.unpinAllMessages](https://core.telegram.org/method/messages.unpinAllMessages)
* Added **saved\_peer\_id** parameter in [messages.getUnreadReactions](https://core.telegram.org/method/messages.getUnreadReactions)
* Added **saved\_peer\_id** parameter in [messages.readReactions](https://core.telegram.org/method/messages.readReactions)
* Added **tabs** parameter in [channels.toggleForum](https://core.telegram.org/method/channels.toggleForum)
* Added **parent\_peer** parameter in [messages.getSavedDialogs](https://core.telegram.org/method/messages.getSavedDialogs)
* Added **flags**, **parent\_peer** parameters in [messages.getSavedHistory](https://core.telegram.org/method/messages.getSavedHistory)
* Added **parent\_peer** parameter in [messages.deleteSavedHistory](https://core.telegram.org/method/messages.deleteSavedHistory)
* Added **flags**, **broadcast\_messages\_allowed** parameters in [channels.updatePaidMessagesPrice](https://core.telegram.org/method/channels.updatePaidMessagesPrice)
...
* Added **broadcast\_messages\_allowed**, **monoforum**, **forum\_tabs**, **linked\_monoforum\_id** parameters in [channel](https://core.telegram.org/constructor/channel)
* Added **saved\_peer\_id** parameter in [updateDraftMessage](https://core.telegram.org/constructor/updateDraftMessage)
* Added **saved\_peer\_id** parameter in [updateChannelReadMessagesContents](https://core.telegram.org/constructor/updateChannelReadMessagesContents)
* Added **saved\_peer\_id** parameter in [updateDialogUnreadMark](https://core.telegram.org/constructor/updateDialogUnreadMark)
* Added **saved\_peer\_id** parameter in [updateMessageReactions](https://core.telegram.org/constructor/updateMessageReactions)
* Added **monoforum\_peer\_id** parameter in [inputReplyToMessage](https://core.telegram.org/constructor/inputReplyToMessage)
* Added **flags**, **broadcast\_messages\_allowed** parameters in [messageActionPaidMessagesPrice](https://core.telegram.org/constructor/messageActionPaidMessagesPrice)
...
* Added **pending\_suggestions**, **dismissed\_suggestions**, **custom\_pending\_suggestion** parameters, changed type of **peer** from **Peer** to **flags.3?Peer** in [help.promoData](https://core.telegram.org/constructor/help.promoData)
* Added **availability\_resale**, **resell\_min\_stars**, **title** parameters in [starGift](https://core.telegram.org/constructor/starGift)
* Added **backdrop\_id** parameter in [starGiftAttributeBackdrop](https://core.telegram.org/constructor/starGiftAttributeBackdrop)
* Added **resell\_stars** parameter in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
* Added **resale\_stars**, **can\_transfer\_at**, **can\_resell\_at** parameters in [messageActionStarGiftUnique](https://core.telegram.org/constructor/messageActionStarGiftUnique)
* Added **can\_transfer\_at**, **can\_resell\_at** parameters in [savedStarGift](https://core.telegram.org/constructor/savedStarGift)
...
* Removed **conference\_call** parameter in [phone.requestCall](https://core.telegram.org/method/phone.requestCall)
* Added **public\_key**, **block** parameters, removed **key\_fingerprint** parameter in [phone.joinGroupCall](https://core.telegram.org/method/phone.joinGroupCall)
* Added **rights** parameter, removed **can\_reply** parameter in [account.updateConnectedBot](https://core.telegram.org/method/account.updateConnectedBot)
...
* Added **flags**, **muted**, **video\_stopped**, **join**, **random\_id**, **public\_key**, **block**, **params** parameters, removed **peer**, **key\_fingerprint** parameters in [phone.createConferenceCall](https://core.telegram.org/method/phone.createConferenceCall)
...
* Added **display\_gifts\_button**, **disallowed\_gifts** parameters in [userFull](https://core.telegram.org/constructor/userFull)
* Removed **conference\_call** parameter in [phoneCallWaiting](https://core.telegram.org/constructor/phoneCallWaiting)
* Removed **conference\_call** parameter in [phoneCallRequested](https://core.telegram.org/constructor/phoneCallRequested)
* Removed **conference\_call** parameter in [phoneCallAccepted](https://core.telegram.org/constructor/phoneCallAccepted)
* Added **conference\_supported** parameter, removed **conference\_call** parameter in [phoneCall](https://core.telegram.org/constructor/phoneCall)
* Removed **conference\_call** parameter in [phoneCallDiscarded](https://core.telegram.org/constructor/phoneCallDiscarded)
* Added **display\_gifts\_button**, **disallowed\_gifts** parameters in [globalPrivacySettings](https://core.telegram.org/constructor/globalPrivacySettings)
* Added **conference**, **creator**, **invite\_link** parameters, removed **conference\_from\_call** parameter in [groupCall](https://core.telegram.org/constructor/groupCall)
* Added **rights** parameter, removed **can\_reply** parameter in [connectedBot](https://core.telegram.org/constructor/connectedBot)
* Added **rights** parameter, removed **can\_reply** parameter in [botBusinessConnection](https://core.telegram.org/constructor/botBusinessConnection)

#### PUSH notification changes

##### New PUSH notifications

* Added [CONF\_CALL\_MISSED](https://core.telegram.org/api/push-updates#conf-call-missed) - `You missed a call from {1}`
...
* Added **allow\_paid\_stars** parameter in [messages.sendMessage](https://core.telegram.org/method/messages.sendMessage)
* Added **allow\_paid\_stars** parameter in [messages.sendMedia](https://core.telegram.org/method/messages.sendMedia)
* Added **allow\_paid\_stars** parameter in [messages.forwardMessages](https://core.telegram.org/method/messages.forwardMessages)
* Added **allow\_paid\_stars** parameter in [messages.sendInlineBotResult](https://core.telegram.org/method/messages.sendInlineBotResult)
* Added **allow\_paid\_stars** parameter in [messages.sendMultiMedia](https://core.telegram.org/method/messages.sendMultiMedia)
* Added **flags**, **for\_paid\_reactions** parameters in [channels.getSendAs](https://core.telegram.org/method/channels.getSendAs)
...
* Added **paid\_message\_stars** parameter in [message](https://core.telegram.org/constructor/message)
* Added **charge\_paid\_message\_stars**, **registration\_month**, **phone\_country**, **name\_change\_date**, **photo\_change\_date** parameters in [peerSettings](https://core.telegram.org/constructor/peerSettings)
* Added **send\_paid\_messages\_stars** parameter, removed **premium\_gifts** parameter in [userFull](https://core.telegram.org/constructor/userFull)
* Added **send\_paid\_messages\_stars** parameter in [user](https://core.telegram.org/constructor/user)
* Added **send\_paid\_messages\_stars** parameter in [channel](https://core.telegram.org/constructor/channel)
* Added **paid\_messages\_available** parameter in [channelFull](https://core.telegram.org/constructor/channelFull)
* Added **noncontact\_peers\_paid\_stars** parameter in [globalPrivacySettings](https://core.telegram.org/constructor/globalPrivacySettings)
* Added **business\_transfer**, **stargift\_resale**, **paid\_messages**, **premium\_gift\_months** parameters in [starsTransaction](https://core.telegram.org/constructor/starsTransaction)
...
* Added **gift\_address** parameter in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
...
* Added **video\_timestamp** parameter in [messages.forwardMessages](https://core.telegram.org/method/messages.forwardMessages)
* Added **stargift** parameter, removed **msg\_id** parameter in [payments.saveStarGift](https://core.telegram.org/method/payments.saveStarGift)
* Added **stargift** parameter, removed **msg\_id** parameter in [payments.convertStarGift](https://core.telegram.org/method/payments.convertStarGift)
* Added **stargift** parameter, removed **msg\_id** parameter in [payments.upgradeStarGift](https://core.telegram.org/method/payments.upgradeStarGift)
* Added **stargift** parameter, removed **msg\_id** parameter, changed type of **to\_id** from **InputUser** to **InputPeer** in [payments.transferStarGift](https://core.telegram.org/method/payments.transferStarGift)
...
* Added **video\_cover**, **video\_timestamp** parameters in [inputMediaUploadedDocument](https://core.telegram.org/constructor/inputMediaUploadedDocument)
* Added **video\_cover**, **video\_timestamp** parameters in [inputMediaDocument](https://core.telegram.org/constructor/inputMediaDocument)
* Added **video\_cover**, **video\_timestamp** parameters in [messageMediaDocument](https://core.telegram.org/constructor/messageMediaDocument)
* Added **stargifts\_available**, **stargifts\_count** parameters in [channelFull](https://core.telegram.org/constructor/channelFull)
* Added **video\_cover**, **video\_timestamp** parameters in [inputMediaDocumentExternal](https://core.telegram.org/constructor/inputMediaDocumentExternal)
* Added **flags**, **until** parameters in [emojiStatus](https://core.telegram.org/constructor/emojiStatus)
* Added **peer** parameter, removed **user\_id** parameter in [inputInvoiceStarGift](https://core.telegram.org/constructor/inputInvoiceStarGift)
* Added **from\_id**, **peer**, **saved\_id** parameters in [messageActionStarGift](https://core.telegram.org/constructor/messageActionStarGift)
* Changed type of **sender\_id** from **flags.0?long** to **flags.0?Peer**, **recipient\_id** from **long** to **Peer** in [starGiftAttributeOriginalDetails](https://core.telegram.org/constructor/starGiftAttributeOriginalDetails)
* Added **owner\_address** parameter, changed type of **owner\_id** from **flags.0?long** to **flags.0?Peer** in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
* Added **from\_id**, **peer**, **saved\_id** parameters in [messageActionStarGiftUnique](https://core.telegram.org/constructor/messageActionStarGiftUnique)
* Added **stargift** parameter, removed **msg\_id** parameter in [inputInvoiceStarGiftUpgrade](https://core.telegram.org/constructor/inputInvoiceStarGiftUpgrade)
* Added **stargift** parameter, removed **msg\_id** parameter, changed type of **to\_id** from **InputUser** to **InputPeer** in [inputInvoiceStarGiftTransfer](https://core.telegram.org/constructor/inputInvoiceStarGiftTransfer)
...
* Added **flags**, **slug**, **owner\_name** parameters, changed type of **owner\_id** from **long** to **flags.0?long** in [starGiftUnique](https://core.telegram.org/constructor/starGiftUnique)
...
* Added [MESSAGE\_STARGIFT\_UPGRADE](https://core.telegram.org/api/push-updates#message-stargift-upgrade) - `{1} upgraded your Gift`
* Added [MESSAGE\_UNIQUE\_STARGIFT](https://core.telegram.org/api/push-updates#message-unique-stargift) - `{1} transferred you a Gift!`