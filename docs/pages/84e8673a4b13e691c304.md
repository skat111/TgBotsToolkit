...
Source: https://core.telegram.org/api/revenue
...
See [here »](https://core.telegram.org/api/stars#balance-and-transaction-history) for more info on how to fetch the channel/bot ad revenue transaction history.

### Revenue statistics

See [here »](https://core.telegram.org/api/stars#revenue-statistics) for more info on how to fetch the channel/bot ad revenue statistics.

### Withdrawing revenue

See [here »](https://core.telegram.org/api/stars#withdrawing-revenue) for more info on how to withdraw channel/bot ad revenue.
