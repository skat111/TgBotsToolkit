...
When the client passes a correct and up to date value, the API will return one of `*NotModified` constructors, e.g. [messages.messagesNotModified](https://core.telegram.org/constructor/messages.messagesNotModified) instead of the actual results.
