...
Source: https://core.telegram.org/api/bots%2Fwebapps
...
The bot's profile page should also show a list of photos and videos, previewing the features offered by the Main Mini App, see [Main Mini App previews](https://core.telegram.org/api/bots%2Fwebapps#main-mini-app-previews) for more info on how to configure and render them.
...
After enabling a [main mini app »](https://core.telegram.org/api/bots%2Fwebapps#main-mini-apps) in [@botfather](https://t.me/botfather), bots gain the ability to display **localized** preview medias (photos and videos) on their profile page, offering examples of what the app can do.
...
Menu button Mini Apps work similarly to [inline button Mini Apps »](https://core.telegram.org/api/bots%2Fwebapps#inline-button-mini-apps): they send messages on behalf of the user to the chat from where the [bot menu button »](https://core.telegram.org/api/bots/menu) was clicked.
...
The full flow is identical to the flow for [inline button Mini Apps »](https://core.telegram.org/api/bots%2Fwebapps#inline-button-mini-apps), apart from the different flags passed to [messages.requestWebView](https://core.telegram.org/method/messages.requestWebView), as described above.

### Attachment menu Mini Apps

Attachment menu Mini Apps work similarly to [inline button Mini Apps »](https://core.telegram.org/api/bots%2Fwebapps#inline-button-mini-apps): they send messages on behalf of the user to the chat where the bot's [attachment menu »](https://core.telegram.org/api/bots/attach) was opened.
...
Not to be confused with [inline button mini apps »](https://core.telegram.org/api/bots%2Fwebapps#inline-button-mini-apps).
...
* `height` - The current height of the visible area of the Mini App (excluding the bottom [main button](https://core.telegram.org/api/bots%2Fwebapps#main-button-pressed), if visible) (integer)
...
* `theme_params` - A [theme parameters object »](https://core.telegram.org/api/bots%2Fwebapps#theme-parameters) (object)
...
Until [web_app_stop_gyroscope](https://core.telegram.org/api/web-events#web-app-stop-gyroscope) is emitted by the mini app, the client will also emit [gyroscope_changed events](https://core.telegram.org/api/bots%2Fwebapps#gyroscope-changed) at most every `refresh_rate` milliseconds with gyroscope readings.
