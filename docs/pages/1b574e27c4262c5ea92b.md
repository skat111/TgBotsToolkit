...
Source: https://core.telegram.org/api/bots%2Fbuttons
...
This flow may also be used by mini apps, as specified [here »](https://core.telegram.org/api/bots%2Fbuttons#requesting-peers-via-mini-apps).
...
* `message`, `alert`, `url` can contain messages and URLs to trigger different client behavior, as [specified above »](https://core.telegram.org/api/bots%2Fbuttons#sending-a-callback-query)
