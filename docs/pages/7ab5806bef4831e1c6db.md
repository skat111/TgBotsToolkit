...
The maximum note length is specified in the [contact_note_length_limit client configuration key »](https://core.telegram.org/api/config#contact-note-length-limit).
