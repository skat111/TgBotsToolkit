...
Source: https://core.telegram.org/bots/2-0-intro

> Howdy! This text assumes that you‘re familiar with Telegram’s bot platform.  
> If this is not the case, kindly check out our [**Introduction to Bots**](https://core.telegram.org/bots).
...
If you'd like a more concise changelog, you can find one in the [**Bot API Manual**](https://core.telegram.org/bots/api#recent-changes).
...
[![](/file/811140217/1/NkRCCLeQZVc/17a804837802700ea4 "Callback buttons in @music")](https://core.telegram.org/file/811140217/1/NkRCCLeQZVc/17a804837802700ea4)
[![](/file/811140659/1/RRJyulbtLBY/ea6163411c7eb4f4dc "More callback buttons in @music")](https://core.telegram.org/file/811140659/1/RRJyulbtLBY/ea6163411c7eb4f4dc)
...
> [Manual: Inline keyboards »](https://core.telegram.org/bots/api#inlinekeyboardmarkup)

#### Callback buttons

When a user presses a **callback button**, no messages are sent to the chat. Instead, your bot simply receives the relevant query. Upon receiving the query, your bot can display some [result in a notification](https://core.telegram.org/bots/api#answercallbackquery) at the top of the chat screen or in an alert.

[![](/file/811140423/1/6BVlO7dWPeo/64d0d842ff73ff3dc8 "Notification at the top")](https://core.telegram.org/file/811140423/1/6BVlO7dWPeo/64d0d842ff73ff3dc8)

**Sample bot**  
[@music](https://telegram.me/music) – This sample music bot uses inline callback buttons to flip pages and reload random results.

Read on to [updating messages](https://core.telegram.org/bots/2-0-intro#updating-messages) to find out how callback buttons can get even cooler.
...
[![](/file/811140999/1/2JSoUVlWKa0/4fad2e2743dc8eda04 "URL button")](https://core.telegram.org/file/811140999/1/2JSoUVlWKa0/4fad2e2743dc8eda04)
...
**Sample bot**  
[@sticker](https://telegram.me/sticker) – This sticker search bot offers a [‘switch to inline’ button](https://core.telegram.org/bots/2-0-intro#switch-to-inline-buttons) to teach users how to use it in inline mode.
...
](/resources/video/cover/Music.png)](/resources/video/Music.mp4)
...
> [Manual: Updating messages »](https://core.telegram.org/bots/api#updating-messages)
...
[![](/file/811140587/2/jaowDLZg2l0/5ba3f7d7fd5c6c28dc "Phone number and location sharing buttons")](https://core.telegram.org/file/811140587/2/jaowDLZg2l0/5ba3f7d7fd5c6c28dc)
...
> [Manual: Types of inline content »](https://core.telegram.org/bots/api#inlinequeryresult)
...
[![](/file/811140558/1/POjp00-nHqE/50d0312845a05e6da9 "New input field")](https://core.telegram.org/file/811140558/1/POjp00-nHqE/50d0312845a05e6da9)
...
> [Manual: Group management »](https://core.telegram.org/bots/api#kickchatmember)
...
> [Read the full changelog for this update »](https://core.telegram.org/bots/api#recent-changes)