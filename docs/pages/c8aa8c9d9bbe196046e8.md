...
Source: https://core.telegram.org/api/account-deletion
...
In this case, if the account's [2FA password](https://core.telegram.org/api/srp) was modified more than 7 days ago and was active in the last 7 days, **account deletion will be delayed for 7 days**.
