...
Source: https://core.telegram.org/api/pin
...
When pinning or unpinning messages, an [updatePinnedMessages](https://core.telegram.org/constructor/updatePinnedMessages) or [updatePinnedChannelMessages](https://core.telegram.org/constructor/updatePinnedChannelMessages) update will be emitted, containing IDs of pinned or unpinned messages.

Pinned messages will also have the `pinned` flag of [message](https://core.telegram.org/constructor/message) set.
