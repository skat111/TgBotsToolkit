...
> If you get a red line under TelegramLongPollingBot, it means you didn't set up your pom.xml correctly. If this is the case, restart from [here](https://core.telegram.org/bots/tutorial#add-framework-dependency).
