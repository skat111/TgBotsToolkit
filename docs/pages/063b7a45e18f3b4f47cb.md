...
Bots also support [threaded conversations](https://core.telegram.org/bots/bots/features#topics-in-private-chats) to manage several different topics in parallel — letting users easily access information from previous chats.
...
> Mini apps can generate media and files – that users can effortlessly share to [other chats](https://core.telegram.org/bots/webapps#sharing-media) or a post [as a story](https://core.telegram.org/bots/webapps#sharing-from-mini-apps-to-stories).

#### Integrate with Services and Devices

Mini apps can **seamlessly integrate** with third-party services, APIs and devices to instantly process and update information – like changing a user's [emoji status](https://core.telegram.org/bots/webapps#setting-emoji-status) when they start a game ![🎮](//telegram.org/img/emoji/40/F09F8EAE.png) or get in a taxi ![🚕](//telegram.org/img/emoji/40/F09F9A95.png).
