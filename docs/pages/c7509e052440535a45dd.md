...
[stars\_rating\_learnmore\_url](https://core.telegram.org/api/config#stars-rating-learnmore-url) will contain a URL that can be shown to users, leading to a page with more info about the Star Rating system.
...
[stars\_revenue\_withdrawal\_max »](https://core.telegram.org/api/config#stars-revenue-withdrawal-max) specifies the maximum amount of [Telegram Stars](https://core.telegram.org/api/stars) that can be [withdrawn »](https://core.telegram.org/api/stars#withdrawing-revenue) from a channel or bot's balance.  
