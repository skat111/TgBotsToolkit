...
Source: https://core.telegram.org/api/file-references%2Fmap-schema

This is the TL schema of the [file reference map file »](https://core.telegram.org/api/file-references).
