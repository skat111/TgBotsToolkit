...
A profile can contain a maximum of [stories\_albums\_limit »](https://core.telegram.org/api/config#stories-albums-limit) albums, each containing a maximum of [stories\_album\_stories\_limit](https://core.telegram.org/api/config#stories-album-stories-limit) stories.
