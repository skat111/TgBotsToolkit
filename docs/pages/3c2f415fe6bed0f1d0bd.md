...
Source: https://core.telegram.org/api/live-location
...
All recent live locations sent to a chat can be fetched using [messages.getRecentLocations](https://core.telegram.org/method/messages.getRecentLocations): this method returns up to 1 location message ([messageMediaGeoLive](https://core.telegram.org/constructor/messageMediaGeoLive)) per chat participant.

Clients will also receive a message with a [messageMediaGeoLive](https://core.telegram.org/constructor/messageMediaGeoLive), containing the information passed by the sender; when the geolocation message is [marked as read](https://core.telegram.org/api/views#read-message-contents), an [updateGeoLiveViewed](https://core.telegram.org/constructor/updateGeoLiveViewed) is generated.
