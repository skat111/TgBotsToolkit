...
Live draft messages should be deleted automatically by graphical clients [message_typing_draft_ttl »](https://core.telegram.org/api/config#message-typing-draft-ttl) seconds after they're received, or when receiving a normal message within the same chat/bot forum topic, whichever comes first.
