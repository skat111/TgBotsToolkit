...
* FILE\_REFERENCE\_EXPIRED: The `file_reference` field of the input location must be [refreshed as specified here »](https://core.telegram.org/api/file-references).
* FILE\_REFERENCE\_INVALID: The `file_reference` field of the input location is invalid and must be [refreshed as specified here »](https://core.telegram.org/api/file-references).
