...
Source: https://core.telegram.org/api/gifs
...
Uploading a GIF will automatically add it to the user's [saved GIFs list »](https://core.telegram.org/api/gifs#saved-gifs).
...
[Uploading »](https://core.telegram.org/api/gifs#uploading-gifs) a GIF will automatically add it to the saved gifs list.

The saved GIFs list should be displayed in the [GIF selection UI »](https://core.telegram.org/api/gifs#searching-gifs).

The maximum number of GIFs that may be added to the saved GIF list is specified by [appConfig.saved_gifs_limit_default](https://core.telegram.org/api/config#saved-gifs-limit-default)/[appConfig.saved_gifs_limit_premium](https://core.telegram.org/api/config#saved-gifs-limit-premium) for non-[Premium](https://core.telegram.org/api/premium)/[Premium](https://core.telegram.org/api/premium) users.
