...
* Added the optional field *is_refunded* to [RequestStatus](https://core.telegram.org/gateway/api#requeststatus), which indicates whether the request fee was refunded.
...
| --- | --- | --- | --- |
| phone_number | String | Yes | The phone number to which you want to send a verification message, in the [E.164](https://en.wikipedia.org/wiki/E.164) format. |
| request_id | String | Optional | The unique identifier of a previous request from [checkSendAbility](https://core.telegram.org/gateway/api#checksendability). If provided, this request will be free of charge. |
| sender_username | String | Optional | Username of the Telegram channel from which the code will be sent. The specified channel, if any, must be [verified](https://telegram.org/verify) and owned by the same account who owns the Gateway API token. |
...
| callback_url | String | Optional | An HTTPS URL where you want to receive [delivery reports](https://core.telegram.org/gateway/api#report-delivery) related to the sent message, 0-256 bytes. |
...
| Parameter | Type | Required | Description |
| --- | --- | --- | --- |
| phone_number | String | Yes | The phone number for which you want to check our ability to send a verification message, in the [E.164](https://en.wikipedia.org/wiki/E.164) format. |
...
| phone_number | String | The phone number to which the verification code was sent, in the [E.164](https://en.wikipedia.org/wiki/E.164) format. |
| request_cost | Float | Total request cost incurred by either [checkSendAbility](https://core.telegram.org/gateway/api#checksendability) or [sendVerificationMessage](https://core.telegram.org/gateway/api#sendverificationmessage). |
...
| delivery_status | [DeliveryStatus](https://core.telegram.org/gateway/api#deliverystatus) | *Optional.* The current message delivery status. Returned only if a verification message was sent to the user. |
| verification_status | [VerificationStatus](https://core.telegram.org/gateway/api#verificationstatus) | *Optional.* The current status of the verification process. |
