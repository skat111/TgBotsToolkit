...
Source: https://core.telegram.org/api/bots%2Freferrals
...
Mini apps, channel owners and simple users can join the referral program as specified [here »](https://core.telegram.org/api/bots%2Freferrals#becoming-an-affiliate).
